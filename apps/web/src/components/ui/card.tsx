...
function Card({
	...
	return (
		<div
			className={cn(
				"group/card flex flex-col gap-4 overflow-hidden rounded-2xl bg-card py-4 text-card-foreground text-xs/relaxed ring-1 ring-foreground/10 has-[>img:first-child]:pt-0 has-data-[slot=card-footer]:pb-0 data-[size=sm]:gap-2 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-t-2xl *:[img:first-child]:rounded-b-none *:[img:last-child]:rounded-t-none *:[img:last-child]:rounded-b-2xl",
				className
			)}
			data-size={size}
			data-slot="card"
